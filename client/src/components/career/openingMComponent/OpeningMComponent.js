...
class OpeningMComponent extends Component {
  render() {
    return (
      <div>
        <div className="ul-opening1">
          ...
          <ul uk-accordion="true">
            <li>
              <a class="uk-accordion-title" href="#" style={{ padding: "8px", fontSize: "12px", backgroundColor: "blue", color: "white", paddingLeft: "16px", borderRadius: "20px" }}>View Details</a>
...
export default OpeningMComponent